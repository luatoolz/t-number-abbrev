describe("number.abbrev.fin", function()
  local t, abbrev, bn, number, k, m, b
  setup(function()
    t = require 't'
  ...
  it("init", function()
    ...
    assert.equal(1200, number(bn('1200')))
    assert.equal(-1200, number(bn('-1200')))
    assert.equal(1200*k, number(bn('1200k')))
    assert.equal(-1200000, number(bn('-1200000')))
    assert.equal(1200000, number(bn('1200k')))
    assert.equal(-1200000, number(bn('-1200k')))
    assert.equal(1200000, number(bn('1.2m')))
    assert.equal(-1200000, number(bn('-1.2m')))
  end)
  it("rounds", function()
    assert.equal(671300000, number(bn('$671.3 Million')))
    assert.equal(671, number(bn(671)))
    assert.equal(671*m, number(bn('$671 Million')))
    assert.equal(671.3*m, number(bn('$671.3 Million')))
    assert.equal(671.37*m, number(bn('$671.37 Million')))

    assert.equal(671.378*m, number(bn('$671.378 Million')))
    ...
    assert.equal(5*m, number(bn('<$5 Million')))
    assert.equal(31.8*b, number(bn('$31.8 Billion')))
    assert.equal(364.1*b, number(bn('$364.1B')))
    assert.equal(26.7*b, number(bn('$26.7B')))
    assert.equal(477*m, number(bn('$477M')))
    assert.equal(5*m, number(bn('<$5M')))
    assert.equal(2.8*b, number(bn('$2.8B')))
    assert.equal(94.5*m, number(bn('$94.5M')))
    assert.equal(181.9*m, number(bn('$181.9M')))
    assert.equal(bn(16.6*b), bn('$16.6B'))
    assert.equal(219.3*m, number(bn('$219.3M')))
    assert.equal(66.8*m, number(bn('$66.8M')))
    assert.equal(36.4*m, number(bn('$36.4M')))
    assert.equal(1.9*b, number(bn('$1.9B')))
    assert.equal(17.5*m, number(bn('$17.5M')))
    assert.equal(6.2*m, number(bn('$6.2M')))
    assert.equal(29.5*m, number(bn('$29.5M')))
    assert.equal(24.6*b, number(bn('$24.6B')))
    assert.equal(204.1*b, number(bn('$204.1B')))
    assert.equal(461.7*m, number(bn('$461.7Million')))
    assert.equal(358.8*m, number(bn('$358.8 Million')))
  end)
  it("string", function()
