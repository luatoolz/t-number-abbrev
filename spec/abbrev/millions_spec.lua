describe("number.abbrev.millions", function()
  ...
  it("init", function()
    ...
    assert.equal(1200000, number(bn('1200000')))
    assert.equal(-1200000, number(bn('-1200000')))
    assert.equal(1200000, number(bn('1200b')))
    assert.equal(-1200000, number(bn('-1200b')))
    assert.equal(1200000, number(bn('1.2t')))
    assert.equal(-1200000, number(bn('-1.2t')))
  end)
  it("rounds", function()
    assert.equal(671300, number(bn('$671.3 Billion')))
    assert.equal(671, number(bn(671)))
    assert.equal(671, number(bn({671})))
    assert.equal(671, number(bn('$671 Million')))
    assert.equal(671, number(bn('$671.3 Million')))
    assert.equal(5, number(bn('<$5 Million')))
    assert.equal(31800, number(bn('$31.8 Billion')))
    assert.equal(364100, number(bn('$364.1B')))
    assert.equal(26700, number(bn('$26.7B')))
    assert.equal(477, number(bn('$477M')))
    assert.equal(5, number(bn('<$5M')))
    assert.equal(2800, number(bn('$2.8B')))
    assert.equal(95, number(bn('$94.5M')))
    assert.equal(182, number(bn('$181.9M')))
    assert.equal(16600, number(bn('$16.6B')))
    assert.equal(219, number(bn('$219.3M')))
    assert.equal(67, number(bn('$66.8M')))
    assert.equal(36, number(bn('$36.4M')))
    assert.equal(1900, number(bn('$1.9B')))
    assert.equal(18, number(bn('$17.5M')))
    assert.equal(6, number(bn('$6.2M')))
    assert.equal(30, number(bn('$29.5M')))
    assert.equal(24600, number(bn('$24.6B')))
    assert.equal(204100, number(bn('$204.1B')))
    assert.equal(462, number(bn('$461.7Million')))
    assert.equal(462, number(bn('$461.7m')))
    assert.equal(462, number(bn('$461.7 M')))
    assert.equal(462, number(bn('$461.7 Million')))
    assert.equal(359, number(bn('$358.8 Million')))
  end)
  it("string", function()
